...
```console
# Modified to Use rockyou.txt
python3 timecrack.py <HASH_FILE> /usr/share/wordlists/rockyou.txt
```
...
<small>*Ref: [Timeroast](https://github.com/SecuraBV/Timeroast)*</small>